...
- **Entities** – Sensors, buttons, device tracker, and enrollment QR image entities are created automatically. They appear under the integration device(s) and under **Settings → Devices & Services → Entities**.
